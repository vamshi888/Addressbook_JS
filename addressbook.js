...
addressBook.push(new Contact("Vamshi","Krishna","kengeri","Bangalore","Karnataka",584123,"91 8722004444","vamshik484@gmail.com"));
...
while (!isExit)
{
    ...
    let userChoice = prompt("Enter the number as per your choice : ");
    switch (userChoice)
    {
        case "1":
